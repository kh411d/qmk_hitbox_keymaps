...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAME1] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX,  GC_DPL,  GC_DPD,  GC_DPR,  XXXXXXX,           XXXXXXX,  GC_SQU,    GC_TRI,  GC_R1,   GC_L1,   XXXXXXX,
    GAME1,   XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,           XXXXXXX,  GC_CRO,    GC_CIR,  GC_R2,   GC_L2,   XXXXXXX,
  ...
  [_GAME2] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, GC_LSL,  GC_LSD,   GC_LSR,  XXXXXXX,           XXXXXXX, GC_SQU,   GC_TRI,  GC_R1,  GC_L1,   XXXXXXX,
    GAME2,   XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,           XXXXXXX, GC_CRO,   GC_CIR,  GC_R2,  GC_L2,   XXXXXXX,
